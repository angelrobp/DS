...
public class CarreraCarretera extends Thread implements Carrera {
	...
	public CarreraCarretera(int n) {
		...
		for (int i = 0; i < n; i++) {
			bicicletas.add(new BicicletaCarretera(TC.CARRETERA, i));
		}
		abandono = n * 10 / 100;
	...
	public void retirarBicicleta() {
		...
		int numero = 0;
		System.out.println("Retirada Carretera:");
		System.out.flush();
		while (abandono>0) {
	...
	public void run() { 
		...
		System.out.println("Carrera de carretera acaba");
	}
}

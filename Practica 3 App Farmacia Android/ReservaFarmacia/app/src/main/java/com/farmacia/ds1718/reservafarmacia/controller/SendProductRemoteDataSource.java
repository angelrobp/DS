...
public class SendProductRemoteDataSource implements RemoteDataSource {
    private static SendProductRemoteDataSource INSTANCE = null;

    private final static String USER_URL = "http://85.55.247.119:8080/RESTful/anadirProductoCarrito";
    private final static String LOG_TAG = "SendRemoteDS";
    private Context context;
    private static String idP, idU;
    private RequestQueue requestQueue;

    private SendProductRemoteDataSource(Context context) {
        this.context = context;
        // Instantiate the RequestQueue
        requestQueue = Volley.newRequestQueue(context);
    }

    public static SendProductRemoteDataSource getInstance(Context context, String mIdP, String mIdU) {
        if (INSTANCE == null) {
            INSTANCE = new SendProductRemoteDataSource(context);
        }
        idU = mIdU;
        idP = mIdP;
        return INSTANCE;
